...
class Box(Hitable):
  def __init__(self,p0,p1,mat):
    ...
    self.pmax = p1
    l = []
    l.append(XyRect(p0.x,p1.x,p0.y,p1.y,p1.z,mat))
    l.append(FlipNormals(XyRect(p0.x,p1.x,p0.y,p1.y,p0.z,mat)))
    l.append(XzRect(p0.x,p1.x,p0.z,p1.z,p1.y,mat))
    l.append(FlipNormals(XzRect(p0.x,p1.x,p0.z,p1.z,p0.y,mat)))
    l.append(YzRect(p0.y,p1.y,p0.z,p1.z,p1.x,mat))
    l.append(FlipNormals(YzRect(p0.y,p1.y,p0.z,p1.z,p0.x,mat)))
    self.list = HitableList(l)
